...
include "../../config/server.php";
	...
	$sql = mysql_query("select * from cbt_siswa WHERE XNomerUjian='$_COOKIE[beeuser]'");
    				...
    				<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<tr height="42px"><td width="30%">Mapel Pilihan/Non Pilihan&nbsp;</td><td>: <td>
								...
								<?php $x= mysql_query("select * from cbt_mapel where XMapelAgama='Y'");
								while($rs = mysql_fetch_array($x)){$sd=$rs['XNamaMapel'];?>
