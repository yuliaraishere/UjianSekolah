...
$sql = mysql_query("update cbt_jawaban set XMulai = '$_REQUEST[waktu]', XPutar='2' where XUserJawab ='$_COOKIE[PESERTA]' and XKodeSoal = '$_REQUEST[soal]' and urut = '$_REQUEST[nomer]' and XTokenUjian = '$_REQUEST[token]'");
}
